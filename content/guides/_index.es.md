...
zona de lectura mecánica, tu fecha de nacimiento y tu firma. Sin tecnicismos y
sin alarmismos — solo qué tapar, por qué importa y cómo hacerlo en un minuto en
tu móvil.

También son honestas sobre el límite. **Censurar no vale en todas partes.** Unos
pocos trámites — la verificación antiblanqueo de un banco, el registro de
viajeros de un hotel, un alta laboral obligatoria — están obligados por ley a
capturar el documento completo, y ahí una barra negra es un trámite fallido, no
una protección. [Cuándo censurar el DNI no sirve de nada](/es/guides/cuando-censurar-el-dni-no-sirve/)
marca exactamente dónde está la línea. Todo lo que queda al otro lado —
compradores de Wallapop, anfitriones, caseros particulares, clientes, el soporte
de una plataforma — es donde estas guías hacen su trabajo, y es la gran mayoría
de lo que de verdad te van a pedir.
...
| [Quien pide un selfi con el documento](/es/guides/selfi-con-el-dni-en-la-mano/) | Comprueba antes el canal | Tu cara, más el nombre y la foto | Número, MRZ, fecha de nacimiento, firma |
| [Un hotel, en el check-in](/es/guides/hotel-pide-copia-del-pasaporte/) | **No** | Número de documento y fecha de nacimiento, por ley | Solo MRZ y firma |
| [Una nueva empresa](/es/guides/empresa-pide-copia-del-dni/) | **No**, para el alta | El documento completo, una vez | Censura solo las copias de más |
| [Un banco](/es/guides/verificacion-de-identidad-en-el-banco/) | **No** | El documento completo, por su app | Nada: verifica la petición |
