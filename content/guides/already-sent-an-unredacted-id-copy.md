---
title: "You already sent an unredacted ID copy. What now?"
subtitle: "What actually matters, what to watch, and what is worth doing today."
...
keywords:
  ...
  - "erasure"
  - "what to do next"
answer: "Work out which fields were actually visible, ask the recipient to delete the copy and confirm, then watch for accounts being opened in your name. Replace the document itself only if it is genuinely compromised — a copy sitting in someone's inbox is a fraud risk, not an invalid passport."
takeaways:
...
faq:
  - q: "I sent a photo of my passport and now think it was a scam. What should I do first?"
    a: "Stop replying, and do not send anything further — including the 'verification fee' or second document that usually follows. Then work out what was visible in the image, report it to the police, and contact your country's embassy or passport authority if you believe the document itself is compromised. Watching your accounts matters more than anything else in the first weeks."
  - q: "Do I need to replace my passport if a photo of it leaked?"
    a: "Usually not. A photo does not invalidate the physical document, and it still works at a border. Replacement becomes worth considering when the document number is circulating in a context you know is fraudulent — that is a judgement call your passport authority or embassy can help with."
  - q: "Can I make a company delete a copy of my ID it should not have?"
    a: "In the EU and UK, yes — you can ask for erasure once the purpose it was collected for has ended, and they need a reason to refuse. Put it in writing and ask for confirmation. Elsewhere, many privacy regimes give similar rights, though the specifics differ."
  - q: "How would I even know if my ID copy was misused?"
    a: "The signals are financial rather than dramatic: credit applications you did not make, accounts or SIM contracts you did not open, letters about services you never signed up for. Those are what to watch for, which is why a credit freeze or fraud alert is more useful than monitoring the document itself."
  - q: "Is it worth doing anything if I sent it to a legitimate business?"
    a: "Yes, but calmly. Ask them to delete it once the check is done, and send a redacted copy next time. The risk from a legitimate recipient is not that they will misuse it — it is that it sits in their systems for years and is exposed if they are ever breached."
---
...
- **The document number** and the **[machine-readable zone]({{< relref "/guides/what-is-the-mrz-machine-readable-zone.md" >}})** — the two together are the serious ones. They are compact, machine-readable and reused by verification systems.
...
If it went to a **business**, ask them to delete it now that the check is done, and ask for written confirmation. In the EU and UK this is a formal right, not a favour — see [can a company legally keep a copy of your ID]({{< relref "/guides/can-a-company-keep-a-copy-of-your-id.md" >}}) for how to word it and where to complain if they refuse.

If it went over **chat or email**, delete it from the thread on your side too. That does not remove the recipient's copy, but it removes yours from a backup that will otherwise outlive the conversation by years — the mechanism described in [is it safe to send your ID over WhatsApp or email]({{< relref "/guides/is-it-safe-to-send-id-over-whatsapp-or-email.md" >}}).
