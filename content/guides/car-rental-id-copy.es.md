...
faq:
  ...
  - q: "¿Cambia algo en un mostrador de aeropuerto frente a uno local?"
    a: "No de forma esencial — se aplican los mismos límites. Los mostradores de aeropuerto gestionan más documentos extranjeros y pueden fotocopiarlo todo por costumbre más que por necesidad, así que sigue mereciendo la pena preguntar qué necesitan conservar de verdad."
---

En el mostrador de alquiler, junto al carné de conducir, te piden «el DNI o el pasaporte también». Es rutina en la mayoría de mostradores — y, como cualquier otra versión de esta petición, merece la pena entregarlo con criterio en lugar de por automatismo.

## Por qué el mostrador pide algo más que el carné
...
Algunos mostradores escanean y guardan una copia mientras dura el alquiler; otros solo consultan el documento y te lo devuelven al momento. Preguntar «¿necesitáis quedaros una copia, o solo comprobarlo?» no cuesta nada y muchas veces significa que después no queda nada que proteger.

## Hazlo desde tu móvil antes de llegar al mostrador

Prepara una copia censurada y con marca de agua — «Para la reserva de [Empresa de alquiler] — [fecha]» — antes de viajar, para no ir con prisas en el mostrador. [Anonymize my ID](/#get) hace todo el proceso en el propio dispositivo en un minuto; consulta [cómo censurar un pasaporte o DNI]({{< relref "/guides/how-to-redact-a-passport-or-id.md" >}}) para el detalle de qué campos tapar.

El viaje es temporal. La copia que dejas en el mostrador no lo es — así que deja una que ya esté censurada precisamente por eso.
